    ...
    <div id="about">
      ...
      <div className="flex flex-col gap-4 text-slate">
        <div className="leading-8">
          ...
          , developing a <b>full-stack content moderation platform with role-based
          workflows</b>.
        </div>
        ...
        <div>
          ...
          exploring something creative - because life shouldn't just compile, it
          should <i>flow.</i>
        </div>
      </div>
      <div className="w-7xl">
        <img src={aakritiImg} className="rounded-xl" />
      </div>
      </div>
    </div>
  )
